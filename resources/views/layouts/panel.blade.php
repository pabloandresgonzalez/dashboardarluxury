...
<head>
  ...
  <!-- Favicon -->
  <link href="{{ asset('img/brand/logo ARL.png') }}" rel="icon" type="image/png">
  <!-- Fonts -->
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="/">
        <img src="{{ asset('img/brand/logo ARL.png') }}" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <p class="mt-3 mb-0 text-muted text-sm">
                    <span class="text-danger mr-2"><i class="fas fa-arrow-up"> Registered Users</i> </span>
                    <span class="text-nowrap"></span>
                  </p>
                </div>
              </div>
